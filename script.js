...
var productList = [
  ...
  var clothingSection = document.getElementById("1");
  var accessorySection = document.getElementById("6");
  
  for (var i= 0; i< products.length; i++)  {
       var currentProduct = products[i];
      if (currentProduct.isAccessory === false) {
          clothingSection.appendChild(card);
      } else {
          accessorySection.appendChild(card);
      }
